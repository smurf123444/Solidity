...
/*             globals.claimStats = _claimStatsEncode(
        ...
        returns (uint256 payout)
    {
        ...
        if (day == BIG_PAY_DAY) {
            uint256 bigPaySlice =/*  gTmp._unclaimedSatoshisTotal */100 * HEARTS_PER_SATOSHI * stakeSharesParam
        ...
        pure
    {
        ...
        */
        ...
        if (day < CLAIM_PHASE_END_DAY) {
            uint256 bigPaySlice = /* g._unclaimedSatoshisTotal */ 100 * HEARTS_PER_SATOSHI / CLAIM_PHASE_DAYS;
...
contract StakeableToken is GlobalsAndUtility {
        ...
        returns (uint256 payout)
    {
        ...
        if (beginDay <= BIG_PAY_DAY && endDay > BIG_PAY_DAY) {
            uint256 bigPaySlice = /* g._unclaimedSatoshisTotal */100 * HEARTS_PER_SATOSHI * stakeSharesParam
