...
export class _Claim extends Entity {
  ...
  set rawAmount(value: BigInt) {
    this.set("rawAmount", Value.fromBigInt(value));
  }
  ...
  get totalClaimedHearts(): BigInt {
    let value = this.get("totalClaimedHearts");
    return value.toBigInt();
  }

  set totalClaimedHearts(value: BigInt) {
    this.set("totalClaimedHearts", Value.fromBigInt(value));
  }
